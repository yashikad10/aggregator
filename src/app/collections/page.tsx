          ...
          {filteredData.length > 0 ? (
            filteredData.map((item, index) => (
              <Link key={index} href={`/singleCollection/${item.slug}`}>
                <tr className='border-b border-[#283277] hover:bg-[#0d103b] transition duration-200 cursor-pointer'>
                  <td className='p-4 flex items-center text-left'>
                    ...
                    <h2 className='hover:underline'>{item.name}</h2>
                  </td>
                  <td className='p-4 text-right'>{item.slug}</td>
                  <td className='p-4 text-right'>{item.floor_price}</td>
        ...
        filteredData.map((item, index) => (
          <Link key={index} href={`/singleCollection/${item.slug}`}>
            <div className='bg-gray-800 p-4 rounded-lg hover:bg-[#25303d] transition duration-200 cursor-pointer'>
              ...
              <p className='text-gray-400 mb-1'>Floor Price: {item.floor_price}</p>
